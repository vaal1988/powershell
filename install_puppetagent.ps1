param([string]$PUPPET_MASTER_SERVER,[string]$PUPPET_AGENT_ENVIRONMENT)

# run from CMD : 
# powershell -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; & ([scriptblock]::Create((irm https://gitlab.com/vaal88/puppet/-/raw/master/windows/powershell/install_puppetagent.ps1))) puppetserver environment"
